...
from models import Field, Name, Phone, Record, AddressBook
...
def main():
    ...
    while True:  
        ...
        def switch_commands(command):
            ...
            result = switcher.get(command, "Invalid command. Available commands: hello, add, change, phone, all, search, close, exit")
